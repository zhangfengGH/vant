<template>
  <div class="m-doc-header">
    <div class="m-doc-row">
      <div class="m-doc-header__top">
        <a class="m-doc-header__logo" :href="config.logo.href">
        ...
        <ul class="m-doc-header__top-nav">
          <li v-for="(value, key) in config.nav" class="m-doc-header__top-nav-item">
            ...
            >
              ...
              <span v-else-if="key === 'lang'" class="m-doc-header__top-nav-lang" @click="onSwitchLang(value)">{{ value.text }}</span>
...
.m-doc-header {
  width: 100%;
  user-select: none;
  border-bottom: 1px solid $m-doc-border-color;

  &__top {
    display: flex;
    align-items: center;
    background-color: #fff;
    padding: 0 $m-doc-padding;
    height: $m-doc-header-top-height;
    line-height: $m-doc-header-top-height;
    ...
    &-nav {
      ...
      .m-doc-header__arrow:hover {
        color: $m-doc-text-color;
      }

      .m-doc-header__arrow::after {
        content: '';
        display: inline-block;
        vertical-align: middle;
        margin-top: -1px;
  ...
  &__bottom {
    height: $m-doc-header-bottom-height;
    line-height: $m-doc-header-bottom-height;
