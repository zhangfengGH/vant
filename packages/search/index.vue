<template>
  <div
    ...
    <div class="m-search__input-wrap" v-clickoutside="onClickoutside">
      <icon name="search" />
      <input
        v-bind="$attrs"
        v-on="listeners"
    ...
    <div class="m-search__action" v-if="showAction">
      <slot name="action">
        <div class="m-search__action-text" @click="onBack">{{ $t('cancel') }}</div>
      </slot>
    </div>
  </div>
</template>
